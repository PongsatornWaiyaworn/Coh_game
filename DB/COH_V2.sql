...
(2, 
 "Write a program that calculates the result of an expression involving two numbers. Your goal is to compute the result of the expression (15 + 5) * 4 - 20 / 5 and The final result should be Result: 76.", 
 "Result: 76",
